...
?>
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="blogdetails.php" class="btn btn-primary">See Details</a>
        </div>
    </div>
...
$sql = "SELECT * FROM blogs ORDER BY votes DESC";
//display all blogs
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <a href="view.php" class="btn btn-primary">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
